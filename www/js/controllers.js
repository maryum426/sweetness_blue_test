...
//          $scope.getUserSweets();
        ...
        $scope.kioskRegister = function(){
            ...
            $scope.kioskSetUser.userPhone = '7076344193';//$rootScope.userPName ;
        ...
        $scope.createPlaceKiosk = function () {
...
*/
        ...
        $scope.creatPlaceKiosk = function (place) {
            ...
            console.log("-->> " + place.description);
            console.log("-->> " + place.url);
            console.log("-->> " + document.getElementById("address").value + ' __ ' + place.address);
            console.log("-->> " + document.getElementById("address2").value + ' __ ' + place.address2);
...
function AppController($window, UpdateService, $http, $log, $scope, $route, $routeParams, $location, userService,$timeout,
    ...
    $scope.nextPage = function () {
        ...
        console.log("Page total size: " + $rootScope.usersInPlaces.length);
        console.log("current Page from swip: " + $scope.currentPagePlace);
    ...
    //alpha
    $scope.prevPage = function () {
        console.log("current Page previous from swip: " + $scope.currentPagePlace);
        if ($scope.currentPagePlace > 0) {
            $scope.currentPagePlace--;
        }
    };
    ...
    $scope.newAuthPlace = function () {
        ...
        console.log("place email -> " + $rootScope.currentPlace[0].get('email'));
    ...
    $scope.newAuthSms = function () {
        ...
        /*$scope.safeApply(function() {
         ...
         authService.loginPhoneNumber($scope.user.phone, function (flag) {
             ...
             console.log("loginPhoneNumber-->$rootScope.userPName: " + $rootScope.userPName + '---' +$scope.user.phone);
